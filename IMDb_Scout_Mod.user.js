...
var public_sites = [
  ...
  {   'name': 'DevilTor',
      ...
      'searchUrl': 'https://devil-torrents.pl/szukaj.php?search=%search_string_orig%+%year%',
      'loggedOutRegex': /Cloudflare|Ray ID|Nie zalogowany/,
      'matchRegex': /kategoria-gatunek-1/,
      'positiveMatch':true,
      'both': true},
  {   'name': 'Dl4All',
...
var chinese_sites = [
  ...
  {   'name': 'BT4G',
      ...
      'searchUrl': 'https://bt4gprx.com/search/%search_string_orig% %year%',
      'loggedOutRegex': /Cloudflare|Ray ID/,
      'ignore404': true,
      'spaceEncode': ' ',
  ...
  {   'name': 'BT4G',
      'icon': 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQBAMAAADt3eJSAAAAGFBMVEX////ExMRGRkYaGhqqqqqYmJiIiIhvb2/FncXiAAAAU0lEQVQI12NgTGCAAFZzAQiD2UwFwioKFQkAM5RUWCBSxQGMEIZwIpTBpAZlsJkJQPUbqUAZzkpQOVZjRQcIK9hIxDERzAoyUjZWB7MYBQUY4AAAUfkIESxqP9YAAAAASUVORK5CYII=',
      'searchUrl': 'https://bt4gprx.com/search/%search_string_orig%',
      'loggedOutRegex': /Cloudflare|Ray ID/,
      'ignore404': true,
      'spaceEncode': ' ',
      'matchRegex': /did not match any/,
  ...
  {   'name': 'CHD',
      ...
      'matchRegex': /Nothing found|没有种子|沒有種子/},
  {   'name': 'Haidan',
      'icon': 'data:image/png;base64,',
  ...
  {   'name': 'Haidan-Req',
      ...
      'both': true},
  {   'name': 'HCT',
      'icon': 'data:image/png;base64,',
  ...
  {   'name': 'HDS',
      'icon': 'data:image/png;base64,',
  ...
  {   'name': 'HDS',
      ...
      'TV': true},
  {   'name': 'HDtime',
      'icon': 'data:image/png;base64,',
      ...
      'both': true},
  {   'name': 'HDU',
      'icon': 'data:image/png;base64,',
  ...
  {   'name': 'HHanClub',
      ...
      'both': true},
  {   'name': 'Itzmx',
      'icon': 'data:image/png;base64,',
      'searchUrl': 'https://pt.itzmx.com/torrents.php?incldead=0&spstate=0&search=%tt%&search_area=1&search_mode=0',
      'loggedOutRegex': /Cloudflare|Ray ID|SSL \(HTTPS\)/,
      'matchRegex': /Nothing found|没有种子|沒有種子/,
      'both': true},
  {   'name': 'JoyHD',
      'icon': 'data:image/png;base64,',
  ...
  {   'name': 'M-T',
      ...
      'searchUrl': 'https://kp.m-team.cc/browse?keyword=https%3A%2F%2Fwww.imdb.com%2Ftitle%2F%tt%&visible=0',
  ...
  {   'name': 'M-T (Title)',
      'icon': 'data:image/png;base64,',
      'searchUrl': 'https://kp.m-team.cc/browse?keyword=%search_string%&visible=0',
      'loggedOutRegex': /Cloudflare|Ray ID|m-team/,
      'matchRegex': /search is not working/,
      'positiveMatch': true,
      'both': true},
  {   'name': 'MonikaDesign',
      'icon': 'data:image/png;base64,',
  ...
  {   'name': 'MonikaDesign-Req',
      ...
      'both': true},
  {   'name': 'NYPT',
      'icon': 'data:image/png;base64,',
  ...
  {   'name': 'OshenPT',
      ...
      'both': true},
  {   'name': 'OurBits',
      'icon': 'data:image/png;base64,',
  ...
  {   'name': 'PTTime',
      ...
      'both': true},
  {   'name': 'TLFBits',
      'icon': 'data:image/png;base64,',
      'searchUrl': 'https://pt.eastgame.org/torrents.php?incldead=1&spstate=0&search=%tt%&search_area=1&search_mode=0',
      'loggedOutRegex': /Cloudflare|Ray ID|SSL \(HTTPS\)/,
      'matchRegex': /Nothing found|没有种子|沒有種子/,
      'both': true},
  {   'name': 'TTG',
      'icon': 'data:image/png;base64,',
      ...
      'both': true},
  {   'name': 'U2',
      'icon': 'data:image/png;base64,',
